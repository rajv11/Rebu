...
struct UsersRepo {
    ...
    init() {
        users = [User(user_id: "batman",firstName: "bruce", lastName: "alloy",email:"bat@cave.com", password: "batMobile", mobile: 6605280403,dob: "12/08/1988",address:address), User(user_id: "superman",firstName: "kent", lastName: "alloy",email:"super@krypton.com", password: "superBoy", mobile: 6605280403,dob: "11/05/1947",address:address)]
    }
